...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure PositionXClick(Sender: TObject);
    procedure PositionYClick(Sender: TObject);
    procedure PosXClick(Sender: TObject);
    procedure PosYClick(Sender: TObject);
    ...
    procedure Belahketupat;
    procedure Trapesium;
    procedure Layanglayang;
    procedure Sikusiku;
...
begin
  //midPoint;
   ...
   begin
       for i:=1 to 5 do
           begin
             //TTitikTri[i].X:=TTitikTri[i].X;
             //TTitikTri[i].Y:=TTitikTri[i].Y;
             // ---------------- Refleksi -------------------
             TTitikTri[i].x:= TTitikTri[i].x*(1) + 0*TTitikTri[i].y;
             TTitikTri[i].y:= TTitikTri[i].x*(0) + (-1)*TTitikTri[i].y;
             // ---------- kembalikan ke titik semula -------
...
procedure TForm1.PositionXClick(Sender: TObject);
begin

end;

procedure TForm1.PositionYClick(Sender: TObject);
begin

end;

procedure TForm1.PosXClick(Sender: TObject);
begin

end;

procedure TForm1.PosYClick(Sender: TObject);
begin
...
procedure TForm1.DrawObject;     // canvasdraw
begin
     //jika canvas 1
    //default
   ...
   if NoObjek=3 then
    ...
    if (NoObjek=4) then
     Canvas1.Canvas.Polyline(TTitikJG);
   if (NoObjek=5) then
     Canvas1.Canvas.Polyline(TTitikBK);
    if (NoObjek=6) then
    Canvas1.Canvas.Polyline(TTitikSiku);
   if (NoObjek=7) then
    Canvas1.Canvas.Polyline(TTitikLay);
   if (NoObjek=8) then
    Canvas1.Canvas.Polyline(TTitiks5);
    if (NoObjek=9) then                   //TAMBAHAN segi 6
    Canvas1.Canvas.Polyline(TTitikS6);
  if (NoObjek=10) then         //drawObj
    Canvas1.Canvas.Polyline(TTitikTrap);
...
procedure TForm1.Segitiga; //
begin
   NoObjek:=2;

     ToolTriangle.Color:=clBlue;
      TTitikTri[1].x:=trunc((Tax+TbX)/2);
      TTitikTri[1].y:=TaY;
      TTitikTri[2].x:=TbX;
      TTitikTri[2].y:=TbY;
      TTitikTri[3].x:=TaX;
...
begin
   ...
   TTitikCir[1].x:=trunc((TaX+TbX)/2);
   TTitikCir[1].y:=trunc((TaY+TbY)/2);
   TTitikCir[2].x:=TbX;
   TTitikCir[2].y:=TbY;
...
procedure TForm1.Jajargenjang;  //
begin
   NoObjek:=4;

      TTitikJG[1].x:=trunc((TbX+TaX)/2);
      TTitikJG[1].y:=TaY;
      TTitikJG[2].x:=TbX;
      TTitikJG[2].y:=TaY;
      TTitikJG[3].x:=trunc((TbX+TaX)/2);
      TTitikJG[3].y:=TbY;
      TTitikJG[4].x:=TaX;
      TTitikJG[4].y:=TbY;
...
procedure TForm1.Belahketupat;  //
begin
   NoObjek:=5;
      TTitikBK[1].x:=trunc((TbX+TaX)/2);
      TTitikBK[1].y:=TaY;
      TTitikBK[2].x:=TbX;
      TTitikBK[2].y:=trunc((TbY+TaY)/2);
      TTitikBK[3].x:=trunc((TbX+TaX)/2);
      TTitikBK[3].y:=TbY;
      TTitikBK[4].x:=TaX;
      TTitikBK[4].y:=trunc((TbY+TaY)/2);
...
procedure TForm1.Layanglayang;    //
begin
   NoObjek:=7;
       TTitikLay[1].x:=trunc((TbX+TaX)/2);
       TTitikLay[1].y:=TaY;
       TTitikLay[2].x:=TaX;
       TTitikLay[2].y:=trunc((TbY-TaY)*1/3+TaY);
       TTitikLay[3].x:=trunc((TbX+TaX)/2);
       TTitikLay[3].y:=TbY;
       TTitikLay[4].x:=TbX;
       TTitikLay[4].y:=trunc((TbY-TaY)*1/3+TaY);
...
procedure TForm1.Trapesium;
begin
    NoObjek:=10;


    TTitikTrap[1].x:=trunc((TaX+TbX)/3);
    TTitikTrap[1].y:=TaY;
    TTitikTrap[2].x:=trunc((TaX+TbX)*2/3);
    TTitikTrap[2].y:=TaY;
    TTitikTrap[3].x:=TbX;
    TTitikTrap[3].y:=TbY;
    TTitikTrap[4].x:=TaX;
...
procedure TForm1.Canvas1MouseDown(Sender: TObject; Button: TMouseButton; // titik awal
  Shift: TShiftState; X, Y: Integer);
begin
  MouseIsDown := True;
  PrevX := X;
...
procedure TForm1.Canvas1MouseMove(Sender: TObject; Shift: TShiftState; X,  // titik akhir
  Y: Integer);
begin
